...
const UserEditProfile = () => {
    return (
        <>
            <form action="">
                <UserProfile />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-[30px] gap-y-[20px] w-full lg:w-[calc(100%-128px)] mx-auto mt-[110px]">
                    <CustomInput
                        label="name"
                        type="text"
                        name="name"
                ...
                <CustomBtn buttonClass='btn-primary font-urbanist text-xl md:text-[28px] font-bold mt-[40px] md:mt-[98px] w-full h-[45px] md:h-[71px]' label='save changes' />
            </form>
        </>
    )
}
