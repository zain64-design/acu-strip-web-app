  ...
  return (
    ...
    <form className={formClass}>
        <div className={`relative flex items-center gap-x-[16px] !bg-(--bg-secondary-2) rounded-md py-[15px] px-[18px] ${searchClass}`}>
            ...
            <CustomInput wrapperClassName="w-full" name={name} inputClassName="w-full font-nunito text-base text-(--text-gray-200) placeholder:font-nunito placeholder:text-base placeholder:text-(--text-gray-200) focus-visible:outline-0" placeholder={placeholder}/>
        </div>
